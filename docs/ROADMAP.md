...
| EPIC1 | PDF compression MVP | Deliver the first polished vertical slice of the product: local PDF compression with a simple, attractive and usable desktop experience. | review |          |
| EPIC5 | CI/CD and releases | Automate tests, documentation publishing, GitHub Pages, tags, and latest-release packaging for every sprint. | new |          |
